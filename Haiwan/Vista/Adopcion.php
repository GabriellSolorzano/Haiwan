...
INNER JOIN departamento ON animal.idDepartamento = departamento.idDepartamento WHERE ;");
?>

<!-- El contenedor y la fila deben estar fuera del bucle -->
<div class="container mt-5">
    <center>  <h1 class="display-5 text-center mb-5 mt-5">Mascotas en Adopción</h1></center>
    <div class="row">
        <?php while ($row = $cons -> fetch_row()) { ?>
            <div class="col-md-3">
                <div class="card" style="width: 18rem;">
                    <!-- Mostrar la imagen -->
                    <img src="data:image/jpeg;base64,<?php echo base64_encode($row[2]); ?>" class="card-img-top" alt="Imagen fundación" style="width:100%; height:auto;">
                    
                    <div class="card-body">
                        <h5 class="card-title"><?php echo $row[1]; ?></h5>
                        <p class="card-text"> 
                        <b>Descripción:</b> <?php echo $row[3]; ?></br>
                        <b>Tipo:</b> <?php echo $row[4]; ?></br>
                        <b>Raza:</b> <?php echo $row[5]; ?></br>
                        
                        <b>Edad:</b> <?php echo $row[9]; ?></br>
