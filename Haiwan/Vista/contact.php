...
<body>
    ...
    <div class="container-fluid page-header py-5 mb-5 wow fadeIn" data-wow-delay="0.1s">
        <div class="container text-center py-5">
            <h1 class="display-3 text-white mb-4 animated slideInDown">Contactanos</h1>
        ...
        <div class="container">
            <div class="row g-5">
                <div class="col-lg-6 wow fadeIn" data-wow-delay="0.1s">
                    <p class="fs-5 fw-bold text-primary">Escribenos</p>
                    <h1 class="display-5 mb-5">¿Deseas contactarnos?</h1>
                    <p class="mb-4">Llena el formulario y escribe al final la pregunta o lo que deseas decirnos, tambien encontraras la ubicacion de nuestra cede principal, no dudes en visitarnos. <br> Pensamos en ti, por eso nos gusta comunicarnos contigo para ofrecerte un mejor servicio, te invitamos a seguirnos en nuestras redes sociales para que conozcas más hacerca de nosotros. <a href="https://htmlcodex.com/contact-form">Download Now</a>.</p>
                    <form>
                        <div class="row g-3">
                            <div class="col-md-6">
